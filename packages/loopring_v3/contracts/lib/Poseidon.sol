...
library Poseidon
{
    ...
    // function mix(HashInputs8 memory i, uint q) internal pure 
    // {
    //     HashInputs8 memory o;
    //     o.t0 = mulmod(i.t0, 9067734253445064890734144122526450279189023719890032859456830213166173619761, q);
    //     o.t0 = addmod(o.t0, mulmod(i.t1, 16378664841697311562845443097199265623838619398287411428110917414833007677155, q), q);
    //     o.t0 = addmod(o.t0, mulmod(i.t2, 12968540216479938138647596899147650021419273189336843725176422194136033835172, q), q);
    //     o.t0 = addmod(o.t0, mulmod(i.t3, 3636162562566338420490575570584278737093584021456168183289112789616069756675, q), q);
    //     o.t0 = addmod(o.t0, mulmod(i.t4, 8949952361235797771659501126471156178804092479420606597426318793013844305422, q), q);
    //     o.t0 = addmod(o.t0, mulmod(i.t5, 13586657904816433080148729258697725609063090799921401830545410130405357110367, q), q);
    //     o.t0 = addmod(o.t0, mulmod(i.t6, 9234644095326950665182299534206533404013403644192586933457524891645396292987, q), q);
    //     o.t0 = addmod(o.t0, mulmod(i.t7, 21716239453658409906539773463855601090749352024072354407676420846971925763352, q), q);
    //     o.t1 = mulmod(i.t0, 2482058150180648511543788012634934806465808146786082148795902594096349483974, q);
    //     o.t1 = addmod(o.t1, mulmod(i.t1, 16563522740626180338295201738437974404892092704059676533096069531044355099628, q), q);
    //     o.t1 = addmod(o.t1, mulmod(i.t2, 10468644849657689537028565510142839489302836569811003546969773105463051947124, q), q);
    //     o.t1 = addmod(o.t1, mulmod(i.t3, 3328913364598498171733622353010907641674136720305714432354138807013088636408, q), q);
    //     o.t1 = addmod(o.t1, mulmod(i.t4, 8642889650254799419576843603477253661899356105675006557919250564400804756641, q), q);
    //     o.t1 = addmod(o.t1, mulmod(i.t5, 14300697791556510113764686242794463641010174685800128469053974698256194076125, q), q);
    //     o.t1 = addmod(o.t1, mulmod(i.t6, 5585884681068831368957819127799934550116264845072199016558603424861777753252, q), q);
    //     o.t1 = addmod(o.t1, mulmod(i.t7, 3478164595623309231528081170973492360030471123077314602599603198947503453402, q), q);
    //     o.t2 = mulmod(i.t0, 970943815872417895015626519859542525373809485973005165410533315057253476903, q);
    //     o.t2 = addmod(o.t2, mulmod(i.t1, 19406667490568134101658669326517700199745817783746545889094238643063688871948, q), q);
    //     o.t2 = addmod(o.t2, mulmod(i.t2, 17049854690034965250221386317058877242629221002521630573756355118745574274967, q), q);
    //     o.t2 = addmod(o.t2, mulmod(i.t3, 4964394613021008685803675656098849539153699842663541444414978877928878266244, q), q);
    //     o.t2 = addmod(o.t2, mulmod(i.t4, 15474947305445649466370538888925567099067120578851553103424183520405650587995, q), q);
    //     o.t2 = addmod(o.t2, mulmod(i.t5, 1016119095639665978105768933448186152078842964810837543326777554729232767846, q), q);
    //     o.t2 = addmod(o.t2, mulmod(i.t6, 1094643194372100629123149177218988304969310518086967353237224710253647912217, q), q);
    //     o.t2 = addmod(o.t2, mulmod(i.t7, 19683112286289404632257045032408336402139497606956310649520051095163041093043, q), q);
    //     o.t3 = mulmod(i.t0, 4770370314098695913091200576539533727214143013236894216582648993741910829490, q);
    //     o.t3 = addmod(o.t3, mulmod(i.t1, 4298564056297802123194408918029088169104276109138370115401819933600955259473, q), q);
    //     o.t3 = addmod(o.t3, mulmod(i.t2, 6905514380186323693285869145872115273350947784558995755916362330070690839131, q), q);
    //     o.t3 = addmod(o.t3, mulmod(i.t3, 4783343257810358393326889022942241108539824540285247795235499223017138301952, q), q);
    //     o.t3 = addmod(o.t3, mulmod(i.t4, 1420772902128122367335354247676760257656541121773854204774788519230732373317, q), q);
    //     o.t3 = addmod(o.t3, mulmod(i.t5, 14172871439045259377975734198064051992755748777535789572469924335100006948373, q), q);
    //     o.t3 = addmod(o.t3, mulmod(i.t6, 701171404446517799603547590964435136387194297039347722754381539762095803416, q), q);
    //     o.t3 = addmod(o.t3, mulmod(i.t7, 9803177017074123807147870516958969882415683917143053879462479514476003798692, q), q);
    //     o.t4 = mulmod(i.t0, 20218246699596954048529384569730026273241102596326201163062133863539137060414, q);
    //     o.t4 = addmod(o.t4, mulmod(i.t1, 1712845821388089905746651754894206522004527237615042226559791118162382909269, q), q);
    //     o.t4 = addmod(o.t4, mulmod(i.t2, 13001155522144542028910638547179410124467185319212645031214919884423841839406, q), q);
    //     o.t4 = addmod(o.t4, mulmod(i.t3, 16037892369576300958623292723740289861626299352695838577330319504984091062115, q), q);
    //     o.t4 = addmod(o.t4, mulmod(i.t4, 19189494548480259335554606182055502469831573298885662881571444557262020106898, q), q);
    //     o.t4 = addmod(o.t4, mulmod(i.t5, 19032687447778391106390582750185144485341165205399984747451318330476859342654, q), q);
    //     o.t4 = addmod(o.t4, mulmod(i.t6, 12323575831655155253804858088151729263068755350164008078826612164541519408135, q), q);
    //     o.t4 = addmod(o.t4, mulmod(i.t7, 13364062595561633544353642535185185386831615196434150714209983763273382358030, q), q);
    //     o.t5 = mulmod(i.t0, 9416416589114508529880440146952102328470363729880726115521103179442988482948, q);
    //     o.t5 = addmod(o.t5, mulmod(i.t1, 8035240799672199706102747147502951589635001418759394863664434079699838251138, q), q);
    //     o.t5 = addmod(o.t5, mulmod(i.t2, 21642389080762222565487157652540372010968704000567605990102641816691459811717, q), q);
    //     o.t5 = addmod(o.t5, mulmod(i.t3, 20261355950827657195644012399234591122288573679402601053407151083849785332516, q), q);
    //     o.t5 = addmod(o.t5, mulmod(i.t4, 14514189384576734449268559374569145463190040567900950075547616936149781403109, q), q);
    //     o.t5 = addmod(o.t5, mulmod(i.t5, 19038036134886073991945204537416211699632292792787812530208911676638479944765, q), q);
    //     o.t5 = addmod(o.t5, mulmod(i.t6, 686782683208273499702675091923241011258708712578932107294509288335035332309, q), q);
    //     o.t5 = addmod(o.t5, mulmod(i.t7, 19460483659494742538635058842962321840203437040436001627070209503346220914620, q), q);
    //     o.t6 = mulmod(i.t0, 5655785191024506056588710805596292231240948371113351452712848652644610823632, q);
    //     o.t6 = addmod(o.t6, mulmod(i.t1, 8265264721707292643644260517162050867559314081394556886644673791575065394002, q), q);
    //     o.t6 = addmod(o.t6, mulmod(i.t2, 17151144681903609082202835646026478898625761142991787335302962548605510241586, q), q);
    //     o.t6 = addmod(o.t6, mulmod(i.t3, 18731644709777529787185361516475509623264209648904603914668024590231177708831, q), q);
    //     o.t6 = addmod(o.t6, mulmod(i.t4, 20697789991623248954020701081488146717484139720322034504511115160686216223641, q), q);
    //     o.t6 = addmod(o.t6, mulmod(i.t5, 6200020095464686209289974437830528853749866001482481427982839122465470640886, q), q);
    //     o.t6 = addmod(o.t6, mulmod(i.t6, 15003643064481014784403977252896879471469342634022488726217418739723899468318, q), q);
    //     o.t6 = addmod(o.t6, mulmod(i.t7, 12647612870405528475535038805212974373775200663189541014169237057917818933775, q), q);
    //     o.t7 = mulmod(i.t0, 9322038271681112575390909338686173013663899980505474147882630774122936723770, q);
    //     o.t7 = addmod(o.t7, mulmod(i.t1, 19539311024738522891356101949155059335275979719197714163855792975479791830596, q), q);
    //     o.t7 = addmod(o.t7, mulmod(i.t2, 6659076024959487416731638372513310695435146898436979094444558067856073756736, q), q);
    //     o.t7 = addmod(o.t7, mulmod(i.t3, 18638411010780926799370141496147754702830985736366292681854483730874058975603, q), q);
    //     o.t7 = addmod(o.t7, mulmod(i.t4, 13991166219115538669786979327638629497368851557264728153209258584901344742173, q), q);
    //     o.t7 = addmod(o.t7, mulmod(i.t5, 10708464376044593093210642907737038037693199311429347815304064429229497756513, q), q);
    //     o.t7 = addmod(o.t7, mulmod(i.t6, 6487544089495620557439978277791925879985014522759859697996101158123830288903, q), q);
    //     o.t7 = addmod(o.t7, mulmod(i.t7, 2913307273815072522855995578822138088278918070152314785631428419886490815017, q), q);
    //     i.t0 = o.t0;
    //     i.t1 = o.t1;
    //     i.t2 = o.t2;
    //     i.t3 = o.t3;
    ...
    // function ark(HashInputs8 memory i, uint q, uint c) internal pure 
    // {
    //     HashInputs8 memory o;
    //     o.t0 = addmod(i.t0, c, q);
    //     o.t1 = addmod(i.t1, c, q);
    ...
    // function sbox_full(HashInputs8 memory i, uint q) internal pure 
    // {
    //     HashInputs8 memory o;
    //     o.t0 = mulmod(i.t0, i.t0, q);
    //     o.t0 = mulmod(o.t0, o.t0, q);
    ...
    // function sbox_partial(HashInputs8 memory i, uint q) internal pure 
    // {
    //     HashInputs8 memory o;
    //     o.t0 = mulmod(i.t0, i.t0, q);
    //     o.t0 = mulmod(o.t0, o.t0, q);
    ...
    // function hash_t8f6p53(HashInputs8 memory i, uint q) internal pure returns (uint)
    // {
    //     // validate inputs
    //     require(i.t0 < q, "INVALID_INPUT");
    //     require(i.t1 < q, "INVALID_INPUT");
    ...
    //     mix(i, q);
    //     // round 58
    //     ark(i, q, 19908645952733301583346063785055921934459499091029406575311417879963332475861);
    //     sbox_full(i, q);
    //     mix(i, q);
