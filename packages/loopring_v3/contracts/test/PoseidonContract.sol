...
contract PoseidonContract {
    ...
    //     returns (uint)
    // {
    //     Poseidon.HashInputs8 memory inputs = Poseidon.HashInputs8(t0, t1, t2, t3, t4, t5, t6, t7);
    //     return Poseidon.hash_t8f6p53(inputs, ExchangeData.SNARK_SCALAR_FIELD);
    // }
}
